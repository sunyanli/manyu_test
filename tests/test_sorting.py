...
class TestBubbleSorter(unittest.TestCase):
    ...
    def test_time_complexity(self) -> None:
        self.assertEqual(self.sorter.time_complexity, "O(n²)")

    def test_space_complexity(self) -> None:
    ...
    def test_sort_negative_numbers(self) -> None:
        self.assertEqual(
    ...
    def test_sort_returns_same_reference(self) -> None:
